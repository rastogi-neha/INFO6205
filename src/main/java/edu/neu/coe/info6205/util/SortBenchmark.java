...
public class SortBenchmark {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for(int sizeOfArray=10000; sizeOfArray<=256000; sizeOfArray*=2){
            ...
            for (int i = 0; i < array.length; i++) array[i] = Integer.toString(random.nextInt(10000000));
            benchmark.benchmarkStringSorters(array,sizeOfArray,config.getInt("benchmarkstringsorters", "runs", 100000));
            benchmark.benchmarkStringSortersInstrumented(array,sizeOfArray,config.getInt("benchmarkstringsorters", "runs", 100000));
            if(sizeOfArray==160000)sizeOfArray=128000;
        }
